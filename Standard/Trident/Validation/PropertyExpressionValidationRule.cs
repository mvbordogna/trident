...
namespace Trident.Validation
{
    ...
    /// Implements the <see cref="Trident.Validation.ValidationRuleBase{TContext}" />
    /// </summary>
         ...
         where TEntity : Entity
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyExpressionValidationRule{TContext, TEntity}"/> class.
        /// </summary>
        protected PropertyExpressionValidationRule()
        {
            ConfigureRules();
        }
