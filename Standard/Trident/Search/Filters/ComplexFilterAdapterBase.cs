...
namespace Trident.Search
{
    ...
    /// Implements the <see cref="Trident.Search.IComplexFilterAdapter{T, TSearchCriteria, TCustomFilter}" />
    /// </summary>
    ...
    /// <seealso cref="Trident.Search.IComplexFilterAdapter{T, TSearchCriteria, TCustomFilter}" />
