...
namespace Trident.Extensions.OpenApi.Visitors
{
    ...
    public abstract class TypeVisitor : IVisitor
    {
        ...
        /// <inheritdoc />
        public virtual void Visit(IAcceptor acceptor, VisitorState state, KeyValuePair<string, Type> type, NamingStrategy namingStrategy, params Attribute[] attributes)
        {
            return;
        }
