...
namespace Trident.Extensions.OpenApi.Visitors
{
    ...
    public class RecursiveObjectTypeVisitor : TypeVisitor
    {
        ...
        public override void Visit(IAcceptor acceptor, VisitorState state, KeyValuePair<string, Type> type, NamingStrategy namingStrategy, params Attribute[] attributes)
        {
            ...
            this.ProcessProperties(instance, state, name, properties, namingStrategy);
        ...
        private void ProcessProperties(IOpenApiSchemaAcceptor instance, VisitorState state,  string schemaName, Dictionary<string, PropertyInfo> properties, NamingStrategy namingStrategy)
        {
