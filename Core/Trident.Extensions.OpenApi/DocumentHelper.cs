...
namespace Trident.Extensions.OpenApi
{
    ...
    public class DocumentHelper : IDocumentHelper
    {
        ...
        /// <inheritdoc />
        public FunctionAttribute GetFunctionNameAttribute(MethodInfo element)
        {
        ...
        /// <inheritdoc />
        public string GetHttpEndpoint(FunctionAttribute function, HttpTriggerAttribute trigger)
        {
        ...
        /// <inheritdoc />
        public OpenApiOperation GetOpenApiOperation(MethodInfo element, FunctionAttribute function, OperationType verb)
        {
        ...
        public Dictionary<string, OpenApiSchema> GetOpenApiSchemas(List<MethodInfo> elements, NamingStrategy namingStrategy, VisitorCollection collection)
        {
            ...
            this._acceptor.Accept(collection, new VisitorState(), namingStrategy);
