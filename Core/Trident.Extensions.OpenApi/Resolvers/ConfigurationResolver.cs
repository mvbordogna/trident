...
using OperatingSystem = Trident.Extensions.OpenApi.Configuration.AppSettings.Extensions.OperationSystem;

namespace Trident.Extensions.OpenApi.Configuration.AppSettings.Resolvers
{
    /// <summary>
