...
namespace Trident.Extensions.OpenApi.Abstractions
{
    ...
    public interface IDocumentHelper
    {
        ...
        FunctionAttribute GetFunctionNameAttribute(MethodInfo element);
        ...
        string GetHttpEndpoint(FunctionAttribute function, HttpTriggerAttribute trigger);
        ...
        OpenApiOperation GetOpenApiOperation(MethodInfo element, FunctionAttribute function, OperationType verb);
