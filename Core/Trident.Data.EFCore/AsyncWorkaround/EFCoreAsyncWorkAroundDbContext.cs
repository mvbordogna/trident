...
namespace Trident.EFCore.AsyncWorkaround
{
    ...
    public abstract class EFCoreAsyncWorkAroundDbContext : EFCoreDataContext
    {
        ...
        public EFCoreAsyncWorkAroundDbContext(IEFCoreModelBuilderFactory modelBuilderFactory, string dataSource, DbContextOptions options)
            : base(modelBuilderFactory,  dataSource,  options)
        {
