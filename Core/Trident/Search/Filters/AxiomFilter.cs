...
namespace Trident.Search
{
    ...
    internal static class AxiomFilterExtensions
    {
        ...
        public static Expression<Func<T, bool>> ToExpression<T>(this Axiom axiom, ParameterExpression paramExpression = null)
        {
            ...
            var equalExpression = !TypeExtensions.IsNullableMember(keyPropertyExpression.Body.Type)
                ? compareExpressionFunc(keyPropertyExpression.Body, constantExpression)
                : TypeExtensions.NullableComparision(compareExpressionFunc, keyPropertyExpression.Body, constantExpression);
