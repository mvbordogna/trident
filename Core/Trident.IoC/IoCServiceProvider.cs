...
namespace Trident.IoC
{
    ...
    public partial class IoCServiceProvider : IServiceProvider, ISupportRequiredService, IDisposable, IAsyncDisposable, IServiceProviderIsService
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IoCServiceProvider"/> class.
        /// </summary>
        /// <param name="lifetimeScope">
        /// The lifetime scope from which services will be resolved.
        /// </param>
        public IoCServiceProvider(IIoCProvider lifetimeScope)
        {
        ...
        /// <see cref="IoCServiceProvider" /> and requires it be present.
        /// </summary>
        ...
        {
            return _lifetimeScope.Get(serviceType);
        }
        ...
        {
            return _lifetimeScope.GetOptional(serviceType);
        }

        /// <summary>
        /// Gets the underlying instance of <see cref="ILifetimeScope" />.
        /// </summary>
        public IIoCProvider LifetimeScope => _lifetimeScope;
        ...
        {
            //need a better way to do this but ok for now
            return _lifetimeScope.GetOptional(serviceType) != null;
        }
    }
}
