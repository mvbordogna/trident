namespace Trident.Core.Contracts
{


    /// <summary>
    /// Commonly used claim types.
    /// Added as part of the interim Security Solution, pre IDS4
    /// This class will be replaced with the orignal Ref from IdentityModel once IDS4 is added
    /// </summary>
